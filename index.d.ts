...
declare module '@medme/lib-jitsi-meet/JitsiMediaDevicesEvents' {
  /**
...
declare module '@medme/lib-jitsi-meet/JitsiMeetJS' {
  var _default: any;
  export default _default;

}
declare module '@medme/lib-jitsi-meet/JitsiParticipant' {
  /**
...
declare module '@medme/lib-jitsi-meet/JitsiParticipantEvents' {

}
declare module '@medme/lib-jitsi-meet/JitsiTrackError' {
...
declare module '@medme/lib-jitsi-meet/JitsiTrackErrors' {
  /**
...
declare module '@medme/lib-jitsi-meet/JitsiTrackEvents' {
  /**
...
declare module '@medme/lib-jitsi-meet/JitsiTranscriptionStatus' {
  /**
...
declare module '@medme/lib-jitsi-meet/authenticateAndUpgradeRole' {
  /**
...
declare module '@medme/lib-jitsi-meet/connection_optimization/external_connect' {
  /**
...
declare module '@medme/lib-jitsi-meet/index' {
  const _exports: any;
  export = _exports;

}
declare module '@medme/lib-jitsi-meet/lib-jitsi-meet.e2ee-worker' {
  export var __esModule: boolean;

}
declare module '@medme/lib-jitsi-meet/modules/RTC/BridgeChannel' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/RTC/JitsiLocalTrack' {
  /**
  ...
  import JitsiTrack from "@medme/lib-jitsi-meet/modules/RTC/JitsiTrack";

}
declare module '@medme/lib-jitsi-meet/modules/RTC/JitsiRemoteTrack' {
  /**
   * Represents a single media track (either audio or video).
   */
...
declare module '@medme/lib-jitsi-meet/modules/RTC/JitsiTrack' {
  /**
   * Represents a single media track (either audio or video).
   */
...
declare module '@medme/lib-jitsi-meet/modules/RTC/LocalSdpMunger' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/RTC/MockClasses' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/RTC/RTC' {
  /**
   *
   */
  ...
  import Listenable from "@medme/lib-jitsi-meet/modules/util/Listenable";
  import TraceablePeerConnection from "@medme/lib-jitsi-meet/modules/RTC/TraceablePeerConnection";
  import BridgeChannel from "@medme/lib-jitsi-meet/modules/RTC/BridgeChannel";
  import JitsiLocalTrack from "@medme/lib-jitsi-meet/modules/RTC/JitsiLocalTrack";
  import * as MediaType from "@medme/lib-jitsi-meet/service/RTC/MediaType";

}
declare module '@medme/lib-jitsi-meet/modules/RTC/RTCUtils' {
...
declare module '@medme/lib-jitsi-meet/modules/RTC/ScreenObtainer' {
...
declare module '@medme/lib-jitsi-meet/modules/RTC/TPCUtils' {
...
declare module '@medme/lib-jitsi-meet/modules/RTC/TraceablePeerConnection' {
  /**
  ...
  import { TPCUtils } from "@medme/lib-jitsi-meet/modules/RTC/TPCUtils";
  import SdpConsistency from "@medme/lib-jitsi-meet/modules/xmpp/SdpConsistency";
  import LocalSdpMunger from "@medme/lib-jitsi-meet/modules/RTC/LocalSdpMunger";
  import RtxModifier from "@medme/lib-jitsi-meet/modules/xmpp/RtxModifier";

}
declare module '@medme/lib-jitsi-meet/modules/browser/BrowserCapabilities' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/browser/index' {
  var _default: BrowserCapabilities;
  export default _default;
  import BrowserCapabilities from "@medme/lib-jitsi-meet/modules/browser/BrowserCapabilities";

}
declare module '@medme/lib-jitsi-meet/modules/connectivity/ConnectionQuality' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/connectivity/IceFailedHandling' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/connectivity/NetworkInfo' {
...
declare module '@medme/lib-jitsi-meet/modules/connectivity/ParticipantConnectionStatus' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/detection/ActiveDeviceDetector' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/detection/DetectionEvents' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/detection/NoAudioSignalDetection' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/detection/P2PDominantSpeakerDetection' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/detection/TrackVADEmitter' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/detection/VADAudioAnalyser' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/detection/VADNoiseDetection' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/detection/VADTalkMutedDetection' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/e2ee/E2EEContext' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/e2ee/E2EEncryption' {
  /**
  ...
  import E2EEContext from "@medme/lib-jitsi-meet/modules/e2ee/E2EEContext";
  import { OlmAdapter } from "@medme/lib-jitsi-meet/modules/e2ee/OlmAdapter";

}
declare module '@medme/lib-jitsi-meet/modules/e2ee/OlmAdapter' {
  /**
  ...
  import Listenable from "@medme/lib-jitsi-meet/modules/util/Listenable";
  import Deferred from "@medme/lib-jitsi-meet/modules/util/Deferred";
...
declare module '@medme/lib-jitsi-meet/modules/e2ee/Worker' {
  export {};

}
declare module '@medme/lib-jitsi-meet/modules/e2ee/crypto-utils' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/e2ee/utils' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/e2eping/e2eping' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/event/Jvb121EventGenerator' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/proxyconnection/ProxyConnectionPC' {
  /**
  ...
  import JingleSessionPC from "@medme/lib-jitsi-meet/modules/xmpp/JingleSessionPC";
  import RTC from "@medme/lib-jitsi-meet/modules/RTC/RTC";

}
declare module '@medme/lib-jitsi-meet/modules/proxyconnection/ProxyConnectionService' {
  /**
  ...
  import ProxyConnectionPC from "@medme/lib-jitsi-meet/modules/proxyconnection/ProxyConnectionPC";

}
declare module '@medme/lib-jitsi-meet/modules/proxyconnection/constants' {
...
declare module '@medme/lib-jitsi-meet/modules/qualitycontrol/QualityController' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/recording/JibriSession' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/recording/RecordingManager' {
  ...
  import JibriSession from "@medme/lib-jitsi-meet/modules/recording/JibriSession";

}
declare module '@medme/lib-jitsi-meet/modules/recording/recordingConstants' {
  namespace _default {
      namespace error {
          const BUSY: string;
          const ERROR: string;
...
declare module '@medme/lib-jitsi-meet/modules/recording/recordingXMLUtils' {
  namespace _default {
      /**
...
declare module '@medme/lib-jitsi-meet/modules/settings/Settings' {
  namespace _default {
...
declare module '@medme/lib-jitsi-meet/modules/statistics/AnalyticsAdapter' {
...
declare module '@medme/lib-jitsi-meet/modules/statistics/AudioOutputProblemDetector' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/statistics/AvgRTPStatsReporter' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/statistics/CallStats' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/statistics/LocalStatsCollector' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/statistics/PerformanceObserverStats' {
  /**
  ...
  import { RunningAverage } from "@medme/lib-jitsi-meet/modules/util/MathUtil";

}
declare module '@medme/lib-jitsi-meet/modules/statistics/PrecallTest' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/statistics/RTPStatsCollector' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/statistics/SpeakerStats' {
  export = SpeakerStats;
  /**
...
declare module '@medme/lib-jitsi-meet/modules/statistics/SpeakerStatsCollector' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/statistics/constants' {
  export const CALLSTATS_SCRIPT_URL: "https://api.callstats.io/static/callstats-ws.min.js";

}
declare module '@medme/lib-jitsi-meet/modules/statistics/statistics' {
  /**
  ...
  import RTPStats from "@medme/lib-jitsi-meet/modules/statistics/RTPStatsCollector";
  import CallStats from "@medme/lib-jitsi-meet/modules/statistics/CallStats";
  import { PerformanceObserverStats } from "@medme/lib-jitsi-meet/modules/statistics/PerformanceObserverStats";
  import analytics from "@medme/lib-jitsi-meet/modules/statistics/AnalyticsAdapter";

}
declare module '@medme/lib-jitsi-meet/modules/transcription/audioRecorder' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/transcription/recordingResult' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/transcription/transcriber' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/transcription/transcriberHolder' {
  export const transcribers: any[];
  export function add(transcriber: any): void;
  export function add(transcriber: any): void;

}
declare module '@medme/lib-jitsi-meet/modules/transcription/transcriptionServices/AbstractTranscriptionService' {
...
declare module '@medme/lib-jitsi-meet/modules/transcription/transcriptionServices/SphinxTranscriptionService' {
...
declare module '@medme/lib-jitsi-meet/modules/transcription/word' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/util/AsyncQueue' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/util/AuthUtil' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/util/Deferred' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/util/EventEmitterForwarder' {
...
declare module '@medme/lib-jitsi-meet/modules/util/GlobalOnErrorHandler' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/util/Listenable' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/util/MathUtil' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/util/RandomUtil' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/util/Retry' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/util/ScriptUtil' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/util/StringUtils' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/util/TestUtils' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/util/UsernameGenerator' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/version/ComponentsVersions' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/videosipgw/JitsiVideoSIPGWSession' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/videosipgw/VideoSIPGW' {
  /**
  ...
  import JitsiVideoSIPGWSession from "@medme/lib-jitsi-meet/modules/videosipgw/JitsiVideoSIPGWSession";

}
declare module '@medme/lib-jitsi-meet/modules/videosipgw/VideoSIPGWConstants' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/webaudio/AudioMixer' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/webaudio/WebAudioUtils' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/Caps' {
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/ChatRoom' {
  ...
  import Listenable from "@medme/lib-jitsi-meet/modules/util/Listenable";
  import XmppConnection from "@medme/lib-jitsi-meet/modules/xmpp/XmppConnection";
  import Moderator from "@medme/lib-jitsi-meet/modules/xmpp/moderator";
  import Lobby from "@medme/lib-jitsi-meet/modules/xmpp/Lobby";
  import * as MediaType from "@medme/lib-jitsi-meet/service/RTC/MediaType";

}
declare module '@medme/lib-jitsi-meet/modules/xmpp/ConnectionPlugin' {
  var _default: {
      new (...args: any[]): {
          connection: any;
          /**
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/JingleSession' {
  /**
  ...
  import Listenable from "@medme/lib-jitsi-meet/modules/util/Listenable";
  import * as JingleSessionState from "@medme/lib-jitsi-meet/modules/xmpp/JingleSessionState";

}
declare module '@medme/lib-jitsi-meet/modules/xmpp/JingleSessionPC' {
  /**
  ...
  import JingleSession from "@medme/lib-jitsi-meet/modules/xmpp/JingleSession";
  import SignalingLayerImpl from "@medme/lib-jitsi-meet/modules/xmpp/SignalingLayerImpl";
  import AsyncQueue from "@medme/lib-jitsi-meet/modules/util/AsyncQueue";
  import SDP from "@medme/lib-jitsi-meet/modules/xmpp/SDP";
  import XmppConnection from "@medme/lib-jitsi-meet/modules/xmpp/XmppConnection";

}
declare module '@medme/lib-jitsi-meet/modules/xmpp/JingleSessionState' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/Lobby' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/MediaSessionEvents' {
  namespace _default {
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/MockClasses' {
  /**
   * Mock {@link ChatRoom}.
   */
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/ResumeTask' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/RtxModifier' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/SDP' {
  /**
   *
   * @param sdp
   */
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/SDPDiffer' {
  /**
   *
   * @param mySDP
   * @param otherSDP
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/SDPUtil' {
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/SampleSdpStrings' {
  namespace _default { }
  export default _default;

}
declare module '@medme/lib-jitsi-meet/modules/xmpp/SdpConsistency' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/SdpTransformUtil' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/SignalingLayerImpl' {
  /**
  ...
  import SignalingLayer from "@medme/lib-jitsi-meet/service/RTC/SignalingLayer";

}
declare module '@medme/lib-jitsi-meet/modules/xmpp/StropheLastSuccess' {
  /**
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/XmppConnection' {
  /**
  ...
  import Listenable from "@medme/lib-jitsi-meet/modules/util/Listenable";
  import LastSuccessTracker from "@medme/lib-jitsi-meet/modules/xmpp/StropheLastSuccess";
  import ResumeTask from "@medme/lib-jitsi-meet/modules/xmpp/ResumeTask";

}
declare module '@medme/lib-jitsi-meet/modules/xmpp/moderator' {
  /**
   *
   * @param roomName
   * @param xmpp
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/strophe.emuc' {
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/strophe.jingle' {
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/strophe.logger' {
  /**
   *
   */
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/strophe.ping' {
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/strophe.rayo' {
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/strophe.util' {
  /**
   *
   */
  export default function _default(): void;
...
declare module '@medme/lib-jitsi-meet/modules/xmpp/xmpp' {
  /**
  ...
  import Listenable from "@medme/lib-jitsi-meet/modules/util/Listenable";
  import XmppConnection from "@medme/lib-jitsi-meet/modules/xmpp/XmppConnection";
  import Caps from "@medme/lib-jitsi-meet/modules/xmpp/Caps";

}
declare module '@medme/lib-jitsi-meet/service/RTC/CameraFacingMode' {
...
declare module '@medme/lib-jitsi-meet/service/RTC/CodecMimeType' {
...
declare module '@medme/lib-jitsi-meet/service/RTC/MediaType' {
  /**
   * The audio type.
   */
...
declare module '@medme/lib-jitsi-meet/service/RTC/RTCEvents' {
...
declare module '@medme/lib-jitsi-meet/service/RTC/Resolutions' {
  export = Resolutions;
  const Resolutions: {
      '1080': {
          width: number;
...
declare module '@medme/lib-jitsi-meet/service/RTC/SignalingEvents' {
  /**
...
declare module '@medme/lib-jitsi-meet/service/RTC/SignalingLayer' {
  /**
...
declare module '@medme/lib-jitsi-meet/service/RTC/StreamEventTypes' {
...
declare module '@medme/lib-jitsi-meet/service/RTC/VideoType' {
  export = VideoType;
  /**
...
declare module '@medme/lib-jitsi-meet/service/authentication/AuthenticationEvents' {
  export const IDENTITY_UPDATED: string;

}
declare module '@medme/lib-jitsi-meet/service/connectivity/ConnectionQualityEvents' {
  /**
...
declare module '@medme/lib-jitsi-meet/service/e2eping/E2ePingEvents' {
  /**
...
declare module '@medme/lib-jitsi-meet/service/statistics/AnalyticsEvents' {
  /**
...
declare module '@medme/lib-jitsi-meet/service/statistics/Events' {
  /**
...
declare module '@medme/lib-jitsi-meet/service/statistics/constants' {
  export const LOCAL_JID: string;

}
declare module '@medme/lib-jitsi-meet/service/xmpp/XMPPEvents' {
